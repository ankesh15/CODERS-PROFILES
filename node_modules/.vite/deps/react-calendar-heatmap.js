...
var MILLISECONDS_IN_ONE_DAY = 24 * 60 * 60 * 1e3;
var DAYS_IN_WEEK = 7;
...
function dateNDaysAgo(numDaysAgo) {
  return shiftDate(/* @__PURE__ */ new Date(), -numDaysAgo);
}
...
var CalendarHeatmap = function(_React$Component) {
  _inherits(CalendarHeatmap2, _React$Component);
  function CalendarHeatmap2() {
    var _getPrototypeOf2;
    var _this;
    _classCallCheck(this, CalendarHeatmap2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CalendarHeatmap2)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _defineProperty(_assertThisInitialized(_this), "getValueCache", memoizeOne(function(props) {
      return props.values.reduce(function(memo, value) {
        ...
        var index = Math.floor((date - _this.getStartDateWithEmptyDays()) / MILLISECONDS_IN_ONE_DAY);
        memo[index] = {
          value,
  ...
  _createClass(CalendarHeatmap2, [{
    key: "getDateDifferenceInDays",
    value: function getDateDifferenceInDays() {
      var _this$props = this.props, startDate = _this$props.startDate, numDays = _this$props.numDays;
      if (numDays) {
    ...
    value: function renderSquare(dayIndex, index) {
      ...
      var _this$getSquareCoordi = this.getSquareCoordinates(dayIndex), _this$getSquareCoordi2 = _slicedToArray(_this$getSquareCoordi, 2), x = _this$getSquareCoordi2[0], y = _this$getSquareCoordi2[1];
      var value = this.getValueForIndex(index);
      var rect = (
        // eslint-disable-next-line jsx-a11y/mouse-events-have-key-events
        import_react.default.createElement("rect", _extends({
          key: index,
          width: SQUARE_SIZE,
          height: SQUARE_SIZE,
          x,
        ...
        }, this.getTooltipDataAttrsForIndex(index)), import_react.default.createElement("title", null, this.getTitleForIndex(index)))
      );
    ...
    value: function renderMonthLabels() {
      ...
      var weekRange = getRange(this.getWeekCount() - 1);
      return weekRange.map(function(weekIndex) {
        var endOfWeek = shiftDate(_this5.getStartDateWithEmptyDays(), (weekIndex + 1) * DAYS_IN_WEEK);
        var _this5$getMonthLabelC = _this5.getMonthLabelCoordinates(weekIndex), _this5$getMonthLabelC2 = _slicedToArray(_this5$getMonthLabelC, 2), x = _this5$getMonthLabelC2[0], y = _this5$getMonthLabelC2[1];
        return endOfWeek.getDate() >= 1 && endOfWeek.getDate() <= DAYS_IN_WEEK ? import_react.default.createElement("text", {
          key: weekIndex,
          x,
          y,
    ...
    value: function renderWeekdayLabels() {
      ...
      return this.props.weekdayLabels.map(function(weekdayLabel, dayIndex) {
        var _this6$getWeekdayLabe = _this6.getWeekdayLabelCoordinates(dayIndex), _this6$getWeekdayLabe2 = _slicedToArray(_this6$getWeekdayLabe, 2), x = _this6$getWeekdayLabe2[0], y = _this6$getWeekdayLabe2[1];
        ...
        return dayIndex & 1 ? import_react.default.createElement("text", {
...
CalendarHeatmap.propTypes = {
  ...
  transformDayElement: propTypes.func
...
var react_calendar_heatmap_esm_default = CalendarHeatmap;
export {
  react_calendar_heatmap_esm_default as default
};
//# sourceMappingURL=react-calendar-heatmap.js.map
