...
const AboutUs = () => (
    <div className="max-w-4xl mx-auto p-6 bg-gray-900">
        <header className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white">CODER PROFILES</h1>
        ...
        <section className="mb-8">
            ...
            <p className="text-white leading-relaxed mb-4">
                Welcome to CODERS Profiles, your one-stop solution for managing and showcasing all your coding profiles. Our platform consolidates your coding activities from various sites, offering a comprehensive overview of your coding journey.
            </p>
            <p className="text-white leading-relaxed">
                Whether you're a competitive programmer, developer, or learner,CODER Profiles helps you track your progress and achievements effortlessly. We aim to bring all your coding accomplishments under one roof, simplifying the way you share your skills with the world.
            </p>
        </section>
        ...
        <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-white space-y-2">
                <li>Aggregate coding profiles from multiple platforms</li>
                <li>Track your progress and achievements over time</li>
                <li>Compare your performance with peers</li>
                <li>Receive insights and analytics on your coding activities</li>
                <li>Showcase your skills and projects in a unified profile</li>
            </ul>
        </section>
        ...
        <section className="mb-8">
            ...
            <p className="text-white leading-relaxed mb-4">
                At CODER Profiles, we envision a future where managing multiple coding profiles is effortless. We aim to create a seamless experience for coders worldwide, allowing them to focus on what they do best—coding.
            </p>
            <p className="text-white leading-relaxed">
                We are committed to continuous improvement and innovation, fostering a community where coders connect, share knowledge, and grow together.
            </p>
        </section>
        ...
        <section>
            ...
            <p className="text-white leading-relaxed">
                ...
                or follow us on our social media channels. Join us in simplifying coding profile management!
            </p>
        </section>
    </div>
);
